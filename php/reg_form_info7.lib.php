...
//Table creation
	...
	if(isset($GLOBALS['_POST']['pre_name']))
	{
		$sql.=(" , `pre_name` varchar(30)");
	}
	if(isset($GLOBALS['_POST']['pre_roll']))
	{
		$sql.=(" , `pre_roll` varchar(10)");
	}
	if(isset($GLOBALS['_POST']['pre_age']))
	{
		$sql.=(" , `pre_age` tinyint");
	}
	if(isset($GLOBALS['_POST']['pre_address']))
	{
		$sql.=(" , `pre_address` text");
	}
	if(isset($GLOBALS['_POST']['pre_dob']))
	{
		$sql.=(" , `pre_dob` date");
	}
	if(isset($GLOBALS['_POST']['pre_mail']))
	{
		$sql.=(" , `pre_mail` varchar(30)");
	}
