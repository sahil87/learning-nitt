...
class AccessTest
{	AccessTest accesstest1 = new AccessTest();
	int yahoo = 234;
		...
		/* BECAUSE HOW CAN ONE ACCESS AN OBJECT THAT CONTAINS ITSELF??? I mean it itself MAKES the oject!!!*/
		//System.out.println("The value of accesstest1.yahoo is " + accesstest1.yahoo);
